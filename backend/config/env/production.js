  ...
  **************************************************************************/
  datastores: {
    ...
    ***************************************************************************/
    default: {
      // adapter: 'sails-mysql',
      // url: `mysql://${process.env.PRO_DATABASE_USER}:${process.env.PRO_DATABASE_PASSWORD}@${process.env.PRO_DATABASE_HOST}:${process.env.PRO_DATABASE_PORT}/${process.env.PRO_DATABASE_NAME}`,
